...
function Dashboard() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 pt-20">
        <div className="text-center p-8 bg-white rounded-3xl shadow-sm border border-gray-100  w-full">
  ...
  return (
    <div className=" bg-gray-50 pt-24 pb-12 px-4 ">
        ...
        <div className="grid grid-cols-1  gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              {products.length === 0 ? (
                <div className="text-center py-12  border-gray-200 rounded-xl">
